...
local vscode = fn.exists('g:vscode') == 1
...
return require('packer').startup(function(raw_use)
    ...
    term_use {"petertriho/nvim-scrollbar", config = function()
    ...
    -- }
    term_use {'feline-nvim/feline.nvim', config = function()
        require 'config.status_line'.setup()
    end}

    term_use {'neovim/nvim-lspconfig', config_mod = 'config.lsp'}
    term_use {'j-hui/fidget.nvim', config = function() require"fidget".setup{} end}
    term_use {'simrat39/rust-tools.nvim', config = function()
    ...
    term_use { 'TimUntersberger/neogit', requires = 'nvim-lua/plenary.nvim', config = function()
    ...
    term_use {"lukas-reineke/indent-blankline.nvim", config = function()
    ...
    term_use {"akinsho/toggleterm.nvim", config = function()
